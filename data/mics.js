...
const MIC_DB = [
  ...
  },
  {
    ...
    msrp: 462,
    needsVerification: false,
    verificationNote: "Classed as small-diaphragm by maintainer decision. Sources genuinely disagree — some call it medium-diaphragm, and it was previously listed here as large — so this is a call, not a settled fact. Reviewed in print by Oct 1986, so it existed by then.",
  },
  {
    id: "akg-d112",
    manufacturer: "AKG",
  ...
  },
  {
    ...
    manufacturer: "Neumann",
    model: "TLM 103",
    displayName: "Neumann TLM 103",
    aliases: ["TLM103", "TLM-103"],
    countryOfOrigin: "Germany",
    operatingPrinciple: "Condenser (Large-Diaphragm)",
    polarPatterns: ["Cardioid"],
    switchable: false,
  ...
  },
  {
    ...
    manufacturer: "Neumann",
    model: "TLM 67",
    displayName: "Neumann TLM 67",
    aliases: ["TLM67", "TLM-67"],
    countryOfOrigin: "Germany",
    operatingPrinciple: "Condenser (Large-Diaphragm)",
    polarPatterns: ["Omnidirectional", "Cardioid", "Figure-8"],
    switchable: true,
  ...
  },
  {
    ...
    manufacturer: "Neumann",
    model: "TLM 49",
    displayName: "Neumann TLM 49",
    aliases: ["TLM49", "TLM-49"],
    countryOfOrigin: "Germany",
    operatingPrinciple: "Condenser (Large-Diaphragm)",
    polarPatterns: ["Cardioid"],
    switchable: false,
